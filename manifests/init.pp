...
class epel (
  ...
  String $epel_playground_mirrorlist                    = $epel::params::epel_playground_mirrorlist,
  String $epel_playground_baseurl                       = $epel::params::epel_playground_baseurl,
  String $epel_playground_failovermethod                = $epel::params::epel_playground_failovermethod,
  String $epel_playground_proxy                         = $epel::params::epel_playground_proxy,
  String $epel_playground_enabled                       = $epel::params::epel_playground_enabled,
  String $epel_playground_gpgcheck                      = $epel::params::epel_playground_gpgcheck,
  String $epel_playground_repo_gpgcheck                 = $epel::params::epel_playground_repo_gpgcheck,
  String $epel_playground_metalink                      = $epel::params::epel_playground_metalink,
  ...
  String $epel_playground_debug_mirrorlist              = $epel::params::epel_playground_debug_mirrorlist,
  String $epel_playground_debug_baseurl                 = $epel::params::epel_playground_debug_baseurl,
  String $epel_playground_debug_failovermethod          = $epel::params::epel_playground_debug_failovermethod,
  String $epel_playground_debug_proxy                   = $epel::params::epel_playground_debug_proxy,
  String $epel_playground_debug_enabled                 = $epel::params::epel_playground_debug_enabled,
  String $epel_playground_debug_gpgcheck                = $epel::params::epel_playground_debug_gpgcheck,
  String $epel_playground_debug_repo_gpgcheck           = $epel::params::epel_playground_debug_repo_gpgcheck,
  String $epel_playground_debug_metalink                = $epel::params::epel_playground_debug_metalink,
