...
class epel (
  String $epel_mirrorlist                               = "https://mirrors.fedoraproject.org/metalink?repo=epel-${epel::params::epel::params::os_maj_release}&arch=\$basearch",
  String $epel_baseurl                                  = 'absent',
  String $epel_failovermethod                           = 'priority',
  String $epel_proxy                                    = 'absent',
  String $epel_enabled                                  = '1',
  String $epel_gpgcheck                                 = '1',
  String $epel_repo_gpgcheck                            = '0',
  String $epel_metalink                                 = "https://mirrors.fedoraproject.org/metalink?repo=epel-${epel::params::epel::params::os_maj_release}&arch=\$basearch",
  ...
  String $epel_testing_mirrorlist                       = "https://mirrors.fedoraproject.org/metalink?repo=testing-epel${epel::params::epel::params::os_maj_release}&arch=\$basearch",
  String $epel_testing_baseurl                          = 'absent',
  String $epel_testing_failovermethod                   = 'priority',
  String $epel_testing_proxy                            = 'absent',
  String $epel_testing_enabled                          = '0',
  String $epel_testing_gpgcheck                         = '1',
  String $epel_testing_repo_gpgcheck                    = '0',
  String $epel_testing_metalink                         = "https://mirrors.fedoraproject.org/metalink?repo=testing-epel${epel::params::epel::params::os_maj_release}&arch=\$basearch",
  ...
  String $epel_source_mirrorlist                        = "https://mirrors.fedoraproject.org/metalink?repo=epel-source-${epel::params::epel::params::os_maj_release}&arch=\$basearch",
  String $epel_source_baseurl                           = 'absent',
  String $epel_source_failovermethod                    = 'priority',
  String $epel_source_proxy                             = 'absent',
  String $epel_source_enabled                           = '0',
  String $epel_source_gpgcheck                          = '1',
  String $epel_source_repo_gpgcheck                     = '0',
  ...
  String $epel_debuginfo_failovermethod                 = 'priority',
  String $epel_debuginfo_proxy                          = 'absent',
  String $epel_debuginfo_enabled                        = '0',
  String $epel_debuginfo_gpgcheck                       = '1',
  String $epel_debuginfo_repo_gpgcheck                  = '0',
  ...
  String $epel_testing_source_failovermethod            = 'priority',
  String $epel_testing_source_proxy                     = 'absent',
  String $epel_testing_source_enabled                   = '0',
  String $epel_testing_source_gpgcheck                  = '1',
  String $epel_testing_source_repo_gpgcheck             = '0',
  ...
  String $epel_testing_debuginfo_failovermethod         = 'priority',
  String $epel_testing_debuginfo_proxy                  = 'absent',
  String $epel_testing_debuginfo_enabled                = '0',
  String $epel_testing_debuginfo_gpgcheck               = '1',
  String $epel_testing_debuginfo_repo_gpgcheck          = '0',
  ...
  String $epel_playground_proxy                         = $epel::params::proxy,
  ...
  String $epel_playground_debug_proxy                   = $epel::params::proxy,
