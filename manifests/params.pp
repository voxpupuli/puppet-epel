...
class epel::params {
  ...
  $epel_testing_failovermethod            = 'absent'
  ...
  $epel_source_failovermethod             = 'absent'
  ...
  $epel_debuginfo_failovermethod          = 'absent'
  ...
  $epel_testing_source_failovermethod     = 'absent'
  ...
  $epel_testing_debuginfo_failovermethod  = 'absent'
